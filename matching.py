...
float_img = cv.imread('makeup/sample.jpg', cv.IMREAD_GRAYSCALE)
ref_img = cv.imread('makeup/model.jpg', cv.IMREAD_GRAYSCALE)
...
cv.imwrite('makeup/matches.jpg', matches_img)
